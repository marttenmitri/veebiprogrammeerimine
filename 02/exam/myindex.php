<?php
  ...
  $weekDayENG = array('Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday', 'Saturday', 'Sunday');
  $weekDaysET = array("esmaspäev", "teisipäev", "kolmapäev", "neljapäev", "reede", "laupäev", "pühapäev");
  $MonthDayENG = array('January', 'February', 'March', 'April', 'May', 'June', 'July', 'August', 'September', 'October', 'November', 'December');
  $monthDaysET = array("jaanuar", "veebruar", "märts", "aprill", "mai", "juuni", "juuli", "august", "september", "oktoober", "november", "detsember");

	$dt = date("j. F , Y, l");;
	$dt = str_ireplace($weekDayENG,$weekDaysET, $dt);
	$dt = str_ireplace($MonthDayENG,$monthDaysET, $dt);
